...
public class SeedingService
{
    ...
    public void Seed()
    {
        ...
        Seller s3 = new Seller( "Alex Grey", "alex_grey@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
        ...
        Seller s6 = new Seller( "Alex Pink", "alex_pink@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
        ...
        SalesRecord r9 = new SalesRecord( new DateTime(2018, 09, 14), 11000.0, SaleStatus.PENDIND, s6);
        ...
        SalesRecord r12 = new SalesRecord( new DateTime(2018, 09, 25), 7000.0, SaleStatus.PENDIND, s3);
        ...
        SalesRecord r27 = new SalesRecord( new DateTime(2018, 10, 13), 9000.0, SaleStatus.PENDIND, s1);
